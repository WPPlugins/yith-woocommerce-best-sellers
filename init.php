...
* Description: YITH WooCommerce Best Sellers allows you to create a bestsellers page and widget, that will make sales in your WooCommerce shop increase.
* Version: 1.1.0
* Author: YITHEMES
...
if ( ! defined( 'YITH_WCBSL_VERSION' ) ){
    define( 'YITH_WCBSL_VERSION', '1.1.0' );
}
